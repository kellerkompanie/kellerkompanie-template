...
["put", ["#BACKPACK_RADIO", "TFAR_anprc155"]] call keko_loadout_keywords;
["put", ["#BACKPACK_MED", "B_Kitbag_rgr"]] call keko_loadout_keywords;
["put", ["#BACKPACK_AUTORIFLE", "B_FieldPack_oli"]] call keko_loadout_keywords;
...
["put", ["DEFAULT", ["U_I_CombatUniform","U_I_CombatUniform_shortsleeve"]]] call keko_loadout_uniform;
["put", ["LEA", ["U_I_OfficerUniform"]]] call keko_loadout_uniform;
["put", ["PIL", ["U_I_HeliPilotCoveralls"]]] call keko_loadout_uniform;	
	


["put", ["DEFAULT", ["V_PlateCarrierIA1_dgtl","V_PlateCarrierIA2_dgtl"]]] call keko_loadout_vest;
["put", ["LEA", ["V_TacVest_oli"]]] call keko_loadout_vest;
["put", ["MED", ["V_PlateCarrierIA2_dgtl"]]] call keko_loadout_vest;
["put", ["DOC", ["V_PlateCarrierIA2_dgtl"]]] call keko_loadout_vest;
["put", ["GRE", ["V_PlateCarrierIAGL_dgtl"]]] call keko_loadout_vest;
...
["put", ["DEFAULT", ["H_HelmetIA"]]] call keko_loadout_helmet;
["put", ["LEA", ["H_MilCap_dgtl"]]] call keko_loadout_helmet;
["put", ["PIL", ["H_PilotHelmetHeli_I"]]] call keko_loadout_helmet;
...
["put", ["GRE", ["B_AssaultPack_dgtl"]]] call keko_loadout_backpack;
...
["put", ["DEFAULT", ["arifle_Mk20C_F"]]] call keko_loadout_primary_weapon;
["put", ["GRE", ["arifle_Mk20_GL_F"]]] call keko_loadout_primary_weapon;
["put", ["MAR", ["srifle_EBR_MRCO_LP_BI_F"]]] call keko_loadout_primary_weapon;
["put", ["LMG", ["LMG_Mk200_LP_BI_F"]]] call keko_loadout_primary_weapon;
["put", ["MMG", ["MMG_02_black_F"]]] call keko_loadout_primary_weapon;


["put", ["DEFAULT", ["acc_pointer_IR","optic_MRCO"]]] call keko_loadout_primary_items;
["put", ["MAR", ["acc_pointer_IR","optic_SOS","bipod_03_F_blk"]]] call keko_loadout_primary_items;
["put", ["LMG", ["acc_pointer_IR","bipod_03_F_blk"]]] call keko_loadout_primary_items;
["put", ["MMG", ["acc_pointer_IR","bipod_03_F_blk"]]] call keko_loadout_primary_items;
