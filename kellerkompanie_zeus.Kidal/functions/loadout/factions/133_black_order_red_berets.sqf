...
_primary_mag_mmg = "hlc_100Rnd_792x57_T_MG42";
...
_mag_count = 4;
_grenade_count = 2;
["put", ["DEFAULT", [[_mag_count, _primary_mag],[_mag_count, _primary_mag_tracer],[1, _smoke_white],[_grenade_count,_grenade],[1,"TRYK_kio_balaclavas"]]]] call keko_loadout_vest_inventory;
...
_vest_inventory_medic pushBack [1, "TRYK_kio_balaclavas"];
...
_vest_inventory_doctor pushBack [1, "TRYK_kio_balaclavas"];
["put", ["DOC", _vest_inventory_doctor]] call keko_loadout_vest_inventory;

["put", ["MAR", [[5, _primary_mag_marksman],[1, _smoke_white],[2, _grenade],[1,"TRYK_kio_balaclavas"],[5, _primary_mag_marksman]]]] call keko_loadout_vest_inventory;
["put", ["LMG", [[4, _primary_mag_lmg],[1,"TRYK_kio_balaclavas"],[1, _smoke_white],[2, _grenade]]]] call keko_loadout_vest_inventory;
["put", ["MMG", [[2, _primary_mag_mmg],[1,"TRYK_kio_balaclavas"],[2, _grenade]]]] call keko_loadout_vest_inventory;
["put", ["UAV", [[2,"ACE_UAVBattery"],[2, _primary_mag],[2, _primary_mag_tracer],[1,"ACE_HuntIR_monitor"],[8,"ACE_HuntIR_M203"],[1,"TRYK_kio_balaclavas"]]]] call keko_loadout_vest_inventory;
["put", ["PIL", [[2, _secondary_mag],[1, "ACE_microDAGR"],[10, "ACE_quikclot"],[1,"TRYK_kio_balaclavas"]]]] call keko_loadout_vest_inventory;



["put", ["DEFAULT", ["TERROR_H_CombatHelmet_1_Red"]]] call keko_loadout_helmet;
["put", ["LEA", ["TERROR_H_Beret_Red"]]] call keko_loadout_helmet;
["put", ["SER", ["TERROR_H_Beret_Red"]]] call keko_loadout_helmet;
["put", ["SQL", ["TERROR_H_Beret_Red"]]] call keko_loadout_helmet;
...
["put", ["LEA", [[1, "ACE_HuntIR_monitor"],[5, "ACE_HuntIR_M203"],[1,"TERROR_H_CombatHelmet_1_Red"]]]] call keko_loadout_backpack_inventory;
["put", ["SER", [[1, "ACE_HuntIR_monitor"],[5, "ACE_HuntIR_M203"],[1,"TERROR_H_CombatHelmet_1_Red"]]]] call keko_loadout_backpack_inventory;
["put", ["JTC", [[4,"Laserbatteries"]]]] call keko_loadout_backpack_inventory;
["put", ["SQL", [[1, "ACE_HuntIR_monitor"],[5, "ACE_HuntIR_M203"],[1,"TERROR_H_CombatHelmet_1_Red"]]]] call keko_loadout_backpack_inventory;
...
["put", ["DEFAULT", ["rhs_weap_hk416d10"]]] call keko_loadout_primary_weapon;
...
["put", ["MMG", ["hlc_lmg_mg42kws_b"]]] call keko_loadout_primary_weapon;


["put", ["DEFAULT", ["rhsusf_acc_anpeq15_bk_light","rhsusf_acc_ACOG_RMR"]]] call keko_loadout_primary_items;
["put", ["MAR", ["rhsusf_acc_anpeq15side_bk","rhsusf_acc_ACOG_MDO","rhsusf_acc_harris_bipod"]]] call keko_loadout_primary_items;
