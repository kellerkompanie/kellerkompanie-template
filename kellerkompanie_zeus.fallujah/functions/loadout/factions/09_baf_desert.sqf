//BAF_DESERT
keko_loadout_uniform = ["UK3CB_BAF_U_CombatUniform_DDPM","UK3CB_BAF_U_CombatUniform_DDPM_RM","UK3CB_BAF_U_CombatUniform_DDPM_ShortSleeve","UK3CB_BAF_U_CombatUniform_DDPM_ShortSleeve_RM"];
keko_loadout_uniform_lead = keko_loadout_uniform;		
keko_loadout_uniform_pilot = ["UK3CB_BAF_U_HeliPilotCoveralls_RAF"];

keko_loadout_vest = ["UK3CB_BAF_V_Osprey_DDPM2","UK3CB_BAF_V_Osprey_DDPM3","UK3CB_BAF_V_Osprey_DDPM4","UK3CB_BAF_V_Osprey_DDPM5","UK3CB_BAF_V_Osprey_DDPM6","UK3CB_BAF_V_Osprey_DDPM7","UK3CB_BAF_V_Osprey_DDPM8","UK3CB_BAF_V_Osprey_DDPM9"];
keko_loadout_vest_lead = ["UK3CB_BAF_V_Osprey_DDPM1"];
...
keko_loadout_helmet = ["UK3CB_BAF_H_Mk6_DDPM_A","UK3CB_BAF_H_Mk6_DDPM_B","UK3CB_BAF_H_Mk6_DDPM_C","UK3CB_BAF_H_Mk6_DDPM_D","UK3CB_BAF_H_Mk6_DDPM_E","UK3CB_BAF_H_Mk6_DDPM_F"];
...
keko_loadout_lr_radio = ["UK3CB_BAF_B_Bergen_DDPM_SL_A","adv_tfar_rt1523g_sage_ind","adv_tfar_rt1523g_sage_opf"];
keko_loadout_backpack_medic = ["UK3CB_BAF_B_Kitbag_DDPM"];
keko_loadout_backpack_autorifle = ["UK3CB_BAF_B_Bergen_DDPM_Rifleman_B"];
keko_loadout_backpack_grenadier = ["UK3CB_BAF_B_Bergen_DDPM_Rifleman_A"];
keko_loadout_backpack_engineer = ["UK3CB_BAF_B_Carryall_DDPM"];
keko_loadout_backpack_at = ["UK3CB_BAF_B_Bergen_DDPM_Rifleman_A"];
