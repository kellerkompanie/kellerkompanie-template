//US Ranger Desert
keko_loadout_uniform = ["TRYK_U_B_3CD_Ranger_BDU","TRYK_U_B_3CD_Ranger_BDUTshirt"];
keko_loadout_uniform_lead = keko_loadout_uniform;	
keko_loadout_uniform_pilot = keko_loadout_uniform;	

keko_loadout_vest = ["TRYK_V_ArmorVest_coyo2","TRYK_V_ArmorVest_khk2","TRYK_V_ArmorVest_coyo","TRYK_V_ArmorVest_khk"];
keko_loadout_vest_lead = ["TRYK_V_PlateCarrier_coyo_L"];
keko_loadout_vest_sql = ["TRYK_V_PlateCarrier_coyo_L"];
keko_loadout_vest_medic = ["TRYK_V_PlateCarrier_coyo"];
keko_loadout_vest_grenadier = ["TRYK_V_PlateCarrier_coyo"];
...
keko_loadout_helmet = ["rhsusf_ach_bare_des","rhsusf_ach_bare_des_ess","rhsusf_ach_bare_des_headset","rhsusf_ach_bare_des_headset_ess","TRYK_H_Helmet_3C"];
keko_loadout_helmet_sql = keko_loadout_helmet;
keko_loadout_helmet_ftl = keko_loadout_helmet;
keko_loadout_helmet_lead = ["LOP_H_Booniehat_RACS"];

keko_loadout_lr_radio = ["TFAR_rt1523g_sage","adv_tfar_rt1523g_sage_ind","adv_tfar_rt1523g_sage_opf"];
keko_loadout_backpack_medic = ["B_Kitbag_cbr"];
keko_loadout_backpack_autorifle = ["rhsusf_falconii_coy"];
keko_loadout_backpack_grenadier = ["TAC_BP_HSG_GLP_Khaki"];
...
keko_loadout_primary_weapon = ["rhs_weap_m4a1_blockII_d"];
keko_loadout_primary_weapon_medic = keko_loadout_primary_weapon;
keko_loadout_primary_weapon_grenadier = ["rhs_weap_m4a1_blockII_M203_d"];
keko_loadout_primary_weapon_marksman = ["rhs_weap_sr25_ec_d"];
keko_loadout_primary_weapon_lmg = ["rhs_weap_m249_pip_S"];
keko_loadout_primary_weapon_mmg = ["rhs_weap_m240B"];

keko_loadout_primary_items = ["rhsusf_acc_anpeq15side_bk","rhsusf_acc_ACOG_RMR","rhsusf_acc_nt4_tan"];
