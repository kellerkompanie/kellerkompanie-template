//MARSOC
keko_loadout_uniform = ["rhs_uniform_g3_m81"];
keko_loadout_uniform_lead = keko_loadout_uniform;	
keko_loadout_uniform_pilot = ["rhs_uniform_g3_m81"];	
...
keko_loadout_backpack_medic = ["rhssaf_kitbag_smb"];
keko_loadout_backpack_autorifle = ["B_AssaultPack_rgr"];
...
keko_loadout_primary_weapon = ["rhs_weap_mk18_KAC"];
keko_loadout_primary_weapon_medic = keko_loadout_primary_weapon;
keko_loadout_primary_weapon_grenadier = ["rhs_weap_mk18_m320"];
...
keko_loadout_primary_items = ["rhsusf_acc_anpeq15","rhsusf_acc_SpecterDR_D","rhsusf_acc_nt4_black"];
