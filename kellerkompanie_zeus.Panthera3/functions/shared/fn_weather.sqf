/*
 * Original author: Belbo [SeL] spezialeinheit-luchs.de
...
_parRandomWeather = missionNamespace getVariable ["keko_par_randomWeather",99];
if !(_parRandomWeather isEqualTo 99) exitWith {};

params [
	["_parWeather",(missionNamespace getVariable ["keko_par_weather",99])]
];
