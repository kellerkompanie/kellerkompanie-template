...
keko_loadout_primary_mag_lmg = "rhs_200rnd_556x45_B_SAW";
...
keko_loadout_vest_inventory = [[10, keko_loadout_primary_mag],[1, keko_loadout_smoke_white],[3,keko_loadout_grenade]];
keko_loadout_vest_inventory_lead = [[10, keko_loadout_primary_mag],[1, keko_loadout_smoke_white],[3,keko_loadout_grenade]];
...
keko_loadout_vest_inventory_grenadier = [[10, keko_loadout_primary_mag],[1, keko_loadout_smoke_white],[3,keko_loadout_grenade]];
...
keko_loadout_helmet = ["TERROR_H_CombatHelmet_1","TERROR_H_CombatHelmet_2"];
...
keko_loadout_primary_items = ["rhsusf_acc_nt4_black","rhsusf_acc_anpeq15","rhsusf_acc_ACOG_RMR"];
...
keko_loadout_primary_items_marksman = ["rhsusf_acc_SR25S","rhsusf_acc_anpeq15side_bk","rhsusf_acc_premier_low","bipod_01_F_blk"];
keko_loadout_primary_items_lmg = [];
keko_loadout_primary_items_mmg = [];

keko_loadout_secondary_weapon = "rhsusf_weap_glock17g4";
keko_loadout_secondary_items = ["rhsusf_acc_omega9k"];
...
keko_loadout_googles = ["G_Bandanna_blk","G_Bandanna_sport","G_Shades_Red","G_Sport_Blackred","rhs_googles_black","BWA3_G_Combat_Black","UK3CB_BAF_G_Tactical_Black"];