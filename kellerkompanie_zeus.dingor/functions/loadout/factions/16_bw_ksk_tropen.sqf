//BW_KSK_TROPEN
keko_loadout_uniform = ["BWA3_Uniform2_Tropen","BWA3_Uniform_Tropen","BWA3_Uniform_idz_Tropen","BWA3_Uniform3_idz_Tropen"];
keko_loadout_uniform_lead = keko_loadout_uniform;	
keko_loadout_uniform_pilot = ["BWA3_Uniform_Helipilot"];	

keko_loadout_vest = ["BWA3_Vest_JPC_Radioman_Tropen","BWA3_Vest_JPC_Rifleman_Tropen","BWA3_Vest_JPC_Leader_Tropen"];
...
keko_loadout_helmet = ["BWA3_Booniehat_Tropen","BWA3_OpsCore_Tropen_Camera","BWA3_OpsCore_Tropen_Patch","BWA3_OpsCore_Tropen","PBW_Buschhut_tropen","H_ShemagOpen_tan","H_ShemagOpen_khk","LOP_H_Shemag_GRE","LOP_H_Shemag_TAN"];
...
keko_loadout_lr_radio = ["TFAR_rt1523g_big_bwmod_tropen","adv_tfar_rt1523g_black_ind","adv_tfar_rt1523g_black_opf"];
keko_loadout_backpack_medic = ["BWA3_Kitbag_Tropen_Medic"];
keko_loadout_backpack_autorifle = ["BWA3_FieldPack_Tropen"];
keko_loadout_backpack_grenadier = ["BWA3_AssaultPack_Tropen"];
keko_loadout_backpack_engineer = ["BWA3_Carryall_Tropen"];
keko_loadout_backpack_at = ["BWA3_FieldPack_Tropen"];
keko_loadout_backpack_rifleman_at = ["BWA3_FieldPack_Tropen"];
...
keko_loadout_primary_weapon = ["rhs_weap_hk416d10_LMT_d"];
...
keko_loadout_primary_weapon_mmg = ["BWA3_MG5_Tan"];

keko_loadout_primary_items = ["rhsusf_acc_rotex5_tan","BWA3_optic_EOTech_tan_Mag_Off","BWA3_acc_VarioRay_irlaser"];
...
keko_loadout_primary_items_lmg = ["BWA3_optic_EOTech_tan_Mag_Off","BWA3_acc_VarioRay_irlaser"];
keko_loadout_primary_items_mmg = ["BWA3_optic_EOTech_tan_Mag_Off","BWA3_acc_VarioRay_irlaser"];
