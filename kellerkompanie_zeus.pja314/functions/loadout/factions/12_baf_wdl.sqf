//BAF_WDL
keko_loadout_uniform = ["UK3CB_BAF_U_CombatUniform_DPMW","UK3CB_BAF_U_CombatUniform_DPMW_RM","UK3CB_BAF_U_CombatUniform_DPMW_ShortSleeve","UK3CB_BAF_U_CombatUniform_DPMW_ShortSleeve_RM"];
keko_loadout_uniform_lead = keko_loadout_uniform;		
keko_loadout_uniform_pilot = ["UK3CB_BAF_U_HeliPilotCoveralls_RAF"];

keko_loadout_vest = ["UK3CB_BAF_V_Osprey_DPMW2","UK3CB_BAF_V_Osprey_DPMW3","UK3CB_BAF_V_Osprey_DPMW4","UK3CB_BAF_V_Osprey_DPMW5","UK3CB_BAF_V_Osprey_DPMW6","UK3CB_BAF_V_Osprey_DPMW7","UK3CB_BAF_V_Osprey_DPMW8","UK3CB_BAF_V_Osprey_DPMW9"];
keko_loadout_vest_lead = ["UK3CB_BAF_V_Osprey_DPMW1"];
...
keko_loadout_helmet = ["UK3CB_BAF_H_Mk6_DPMW_A","UK3CB_BAF_H_Mk6_DPMW_B","UK3CB_BAF_H_Mk6_DPMW_C","UK3CB_BAF_H_Mk6_DPMW_D","UK3CB_BAF_H_Mk6_DPMW_E","UK3CB_BAF_H_Mk6_DPMW_F"];
...
keko_loadout_lr_radio = ["UK3CB_BAF_B_Bergen_DPMW_SL_A","adv_tfar_rt1523g_sage_ind","adv_tfar_rt1523g_sage_opf"];
keko_loadout_backpack_medic = ["UK3CB_BAF_B_Kitbag_DPMW"];
keko_loadout_backpack_autorifle = ["UK3CB_BAF_B_Bergen_DPMW_Rifleman_B"];
keko_loadout_backpack_grenadier = ["UK3CB_BAF_B_Bergen_DPMW_Rifleman_A"];
keko_loadout_backpack_engineer = ["UK3CB_BAF_B_Carryall_DPMW"];
keko_loadout_backpack_at = ["UK3CB_BAF_B_Bergen_DPMW_Rifleman_A"];
