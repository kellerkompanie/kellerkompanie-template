//ARMY_OCP
keko_loadout_uniform = ["rhs_uniform_cu_ocp","rhs_uniform_cu_ocp_101st","rhs_uniform_cu_ocp_10th","rhs_uniform_cu_ocp_1stcav","rhs_uniform_cu_ocp_82nd"];
keko_loadout_uniform_lead = keko_loadout_uniform;		
keko_loadout_uniform_pilot = ["rhs_uniform_cu_ocp_1stcav"];

keko_loadout_vest = ["rhsusf_iotv_ocp_Rifleman"];
keko_loadout_vest_lead = ["rhsusf_iotv_ocp_Teamleader"];
keko_loadout_vest_sql = ["rhsusf_iotv_ocp_Squadleader"];
keko_loadout_vest_medic = ["rhsusf_iotv_ocp_Medic"];
keko_loadout_vest_grenadier = ["rhsusf_iotv_ocp_Repair","rhsusf_iotv_ocp_Grenadier"];
keko_loadout_vest_lmg = ["rhsusf_iotv_ocp_SAW"];
...
keko_loadout_helmet = ["rhsusf_ach_helmet_ocp_norotos","rhsusf_ach_helmet_camo_ocp","rhsusf_ach_helmet_headset_ess_ocp","rhsusf_ach_helmet_headset_ocp","rhsusf_ach_helmet_ESS_ocp","rhsusf_ach_helmet_ocp"];
keko_loadout_helmet_sql = keko_loadout_helmet;
keko_loadout_helmet_ftl = keko_loadout_helmet;
keko_loadout_helmet_lead = ["rhsusf_patrolcap_ocp"];

keko_loadout_lr_radio = ["TFAR_rt1523g_rhs","adv_tfar_rt1523g_rhs_ind","adv_tfar_rt1523g_rhs_opf"];
keko_loadout_backpack_medic = ["rhsusf_assault_eagleaiii_ocp"];
keko_loadout_backpack_autorifle = ["rhsusf_assault_eagleaiii_ocp"];
keko_loadout_backpack_grenadier = ["rhsusf_assault_eagleaiii_ocp"];
keko_loadout_backpack_engineer = ["rhsusf_assault_eagleaiii_ocp"];
