...
keko_loadout_vest = ["UK3CB_BAF_V_PLCE_Webbing_Plate_Winter"];
...
keko_loadout_helmet = ["UK3CB_BAF_H_Mk7_Win_A","UK3CB_BAF_H_Mk7_Win_ESS_A"];
...
keko_loadout_lr_radio = ["UK3CB_BAF_B_Bergen_Arctic_SL_A","adv_tfar_rt1523g_sage_ind","adv_tfar_rt1523g_sage_opf"];
keko_loadout_backpack_medic = ["UK3CB_BAF_B_Kitbag_Arctic"];
keko_loadout_backpack_autorifle = ["UK3CB_BAF_B_Bergen_Arctic_Rifleman_A"];
keko_loadout_backpack_grenadier = ["UK3CB_BAF_B_Bergen_Arctic_Rifleman_A"];
keko_loadout_backpack_engineer = ["UK3CB_BAF_B_Carryall_Arctic"];
keko_loadout_backpack_at = ["UK3CB_BAF_B_Bergen_Arctic_Rifleman_B"];
