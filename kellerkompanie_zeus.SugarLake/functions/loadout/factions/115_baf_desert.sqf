...
_lr_radio = "UK3CB_BAF_B_Bergen_DDPM_SL_A";
_backpack_med = "UK3CB_BAF_B_Kitbag_DDPM";
_backpack_autorifle = "UK3CB_BAF_B_Bergen_DDPM_Rifleman_B";
_backpack_engineer = "UK3CB_BAF_B_Carryall_DDPM";
_backpack_specialist = "UK3CB_BAF_B_Bergen_DDPM_Rifleman_A";
