...
keko_loadout_uniform = ["PLA_CombatUniform_SB","PLA_CombatUniform_SBCB"];
keko_loadout_uniform_lead = ["PLA_CombatUniform_SWCB","PLA_CombatUniform_SW"];	
keko_loadout_uniform_pilot = keko_loadout_uniform;	

keko_loadout_vest = ["PLA_B04_RF","PLA_T15Vest_RF"];
keko_loadout_vest_lead = ["PLA_T15Vest_RD"];
keko_loadout_vest_sql = ["PLA_T15Vest_RD"];
keko_loadout_vest_medic = keko_loadout_vest;
keko_loadout_vest_grenadier = keko_loadout_vest;
keko_loadout_vest_lmg = ["PLA_B04_MG"];
keko_loadout_vest_mmg = ["PLA_B04_MG"];
...
keko_loadout_helmet = ["VME_PLA_Helmet","VME_PLA_Helmet_G"];
keko_loadout_helmet_sql = ["VME_PLA_Helmet_R_O","VME_PLA_Helmet_R"];
keko_loadout_helmet_ftl = keko_loadout_helmet_sql;
keko_loadout_helmet_lead = ["VME_PLA_Hat"];
...
keko_loadout_backpack_autorifle = ["TRYK_B_AssaultPack_UCP"];
keko_loadout_backpack_grenadier = ["TAC_BP_HSG_GLP2_B"];
keko_loadout_backpack_engineer = ["B_Carryall_oucamo"];
keko_loadout_backpack_at = ["B_FieldPack_oucamo"];
