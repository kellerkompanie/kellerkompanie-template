//BW_TROPEN
keko_loadout_uniform = ["PBW_Uniform3_tropen","PBW_Uniform4_tropen","PBW_Uniform4K_tropen"];
...
keko_loadout_helmet = ["PBW_Helm1_tropen","PBW_Helm2_tropen","PBW_Helm2_tropen_H","PBW_Helm1_tropen_HBOD","PBW_Helm1_tropen_HBO","PBW_Helm1_tropen_H"];
keko_loadout_helmet_sql = keko_loadout_helmet;
keko_loadout_helmet_ftl = keko_loadout_helmet;
keko_loadout_helmet_lead = ["PBW_muetze2_tropen"];
