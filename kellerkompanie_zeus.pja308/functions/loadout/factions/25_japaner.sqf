//Japaner
keko_loadout_uniform = ["TRYK_U_B_JSDF_CombatUniform","TRYK_U_B_JSDF_CombatUniformTshirt"];
keko_loadout_uniform_lead = keko_loadout_uniform;	
keko_loadout_uniform_pilot = keko_loadout_uniform;	

keko_loadout_vest = ["TRYK_V_PlateCarrier_JSDF"];
...
keko_loadout_primary_mag = "hlc_30rnd_556x45_EPR_HK33";
keko_loadout_primary_mag_medic = keko_loadout_primary_mag;
keko_loadout_primary_mag_tracer = "hlc_30rnd_556x45_t_HK33";
...
keko_loadout_primary_mag_mmg = "hlc_100Rnd_762x51_T_M60E4";
...
keko_loadout_vest_inventory_marksman = [[5, keko_loadout_primary_mag_marksman],[5, "hlc_20rnd_762x51_T_G3"],[1, keko_loadout_smoke_white],[3,keko_loadout_grenade]];
...
keko_loadout_helmet = ["TRYK_H_Helmet_JSDF"];
keko_loadout_helmet_sql = keko_loadout_helmet;
keko_loadout_helmet_ftl = keko_loadout_helmet;
keko_loadout_helmet_lead = ["TRYK_H_Booniehat_JSDF"];

keko_loadout_lr_radio = ["TFAR_rt1523g_green","adv_tfar_rt1523g_green_ind","adv_tfar_rt1523g_green_opf"];
keko_loadout_backpack_medic = ["TRYK_B_Kitbag_Base_JSDF"];
keko_loadout_backpack_autorifle = ["TRYK_B_AssaultPack_Type2camo"];
keko_loadout_backpack_grenadier = ["TAC_BP_HSG_GLP_OD"];
keko_loadout_backpack_engineer = ["TRYK_B_Carryall_JSDF"];
keko_loadout_backpack_at = ["B_FieldPack_oli"];
keko_loadout_backpack_rifleman_at = ["TRYK_B_AssaultPack_Type2camo"];
...
keko_loadout_primary_weapon = ["hlc_rifle_hk33a2RIS"];
keko_loadout_primary_weapon_medic = keko_loadout_primary_weapon;
keko_loadout_primary_weapon_grenadier = ["hlc_rifle_hk33a2RIS_GL"];
keko_loadout_primary_weapon_marksman = ["hlc_rifle_g3ka4"];
keko_loadout_primary_weapon_lmg = ["rhs_weap_m249_pip_S"];
keko_loadout_primary_weapon_mmg = ["hlc_lmg_m60"];

keko_loadout_primary_items = ["rhsusf_acc_anpeq15side_bk","UK3CB_BAF_TA31F"];
...
keko_loadout_primary_items_marksman = ["rhsusf_acc_anpeq15side_bk","UK3CB_BAF_TA648","rhsusf_acc_harris_bipod"];
